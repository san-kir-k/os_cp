...
namespace Seabattle {
    ...
    {{~0, ~0, ~0, ~v4, ~v4, ~v4},
     {~0, ~0, ~0, ~(v4 | v3), ~(v4 | v3), ~(v4 | v3)},
     {~0, ~0, ~0, ~(v4| v3| v2), ~(v4| v3| v2), ~(v4| v3| v2)},
    ...
    {{~0, ~0, ~0, ~v4, ~v4, ~v4, ~v4},
     {~0, ~0, ~0, ~(v4 | v3), ~(v4 | v3), ~(v4 | v3), ~(v4 | v3)},
     {~0, ~0, ~0, ~(v4| v3| v2), ~(v4| v3| v2), ~(v4| v3| v2), ~(v4| v3| v2)},
    ...
    {{~0, ~0, ~0, ~v4, ~v4, ~v4, ~v4, ~v4},
     {~0, ~0, ~0, ~(v4 | v3), ~(v4 | v3), ~(v4 | v3), ~(v4 | v3), ~(v4 | v3)},
     {~0, ~0, ~0, ~(v4| v3| v2), ~(v4| v3| v2), ~(v4| v3| v2), ~(v4| v3| v2), ~(v4| v3| v2)},
    ...
    {{~0, ~0, ~0, ~v4, ~v4, ~v4, ~v4, ~v4, ~v4},
     {~0, ~0, ~0, ~(v4 | v3), ~(v4 | v3), ~(v4 | v3), ~(v4 | v3), ~(v4 | v3), ~(v4 | v3)},
     {~0, ~0, ~0, ~(v4| v3| v2), ~(v4| v3| v2), ~(v4| v3| v2), ~(v4| v3| v2), ~(v4| v3| v2), ~(v4| v3| v2)},
            ...
            void _update(std::vector<std::vector<int>>& av_map, direction dir, int len, int row, int col) {
                ...
                for (int i = 0; i < matrix.size(); ++i) {
                    for (int j = 0; i < matrix[i].size(); ++j) {
                        if (row + i < MSIZE && col + j < MSIZE) {
                            av_map[row + i][col + j] = av_map[row + i][col + j] & matrix[i][j];
                            if (dir == direction::left) {
                                if (matrix[i][j] & (~h1) != 0) {
                                    boats_h_slots--;
                                }
